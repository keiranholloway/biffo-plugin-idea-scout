...
plugin subscribes to (see `plugin.py`) through `IdeaScoutPlugin`'s
...
from .plugin import IdeaScoutPlugin
...
_plugin: IdeaScoutPlugin | None = None


def _get_plugin() -> IdeaScoutPlugin:
