"""IdeaScoutPlugin — this plugin's BiffoPluginBase implementation.
...
_PLUGIN_BASE_PATH = "/api/v1/plugins/idea-scout"
...
class IdeaScoutPlugin(BiffoPluginBase):
